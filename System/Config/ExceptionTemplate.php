...
return array(
	...
	'update browser' => function ($fun) {
		echo "<html>
				<body style='background: #2d2d2d; color: white; font-family: 微软雅黑;'>
					<div style='position: fixed; font-size:60px;  top: 50%; left: 50%; margin-left: -310px; margin-top: -39px;'>异常：浏览器版本过低！</div>
				</body>
			</html>";
		$fun();
	},
	'no found page' => function () {
